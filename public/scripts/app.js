...
var IndecisionApp = function (_React$Component) {
    ...
    _createClass(IndecisionApp, [{
        ...
        //Gets called after the props or state value changes
        ...
        value: function handleAddOption(option) {
            ...
            //If a valid message is returned we get undefined back.
...
var Options = function Options(props) {
    return React.createElement(
        ...
        props.options.length === 0 && React.createElement(
            'p',
            null,
            'Enter a valid option to get started!'
        ),
...
var AddOption = function (_React$Component2) {
    ...
    _createClass(AddOption, [{
        ...
        value: function onAddOption(e) {
            //prevents the whole page refresh on submition. not what we want!
            e.preventDefault();
